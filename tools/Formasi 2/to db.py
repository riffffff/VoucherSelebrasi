...
# Buka file JSON
with open("E:/Voucher Selebrasi/Formasi 2/formasi2.json", "r", encoding="utf-8") as f:
    data = json.load(f)
...
cursor.execute('''
    CREATE TABLE IF NOT EXISTS formasi2 (
...
for item in data:
    cursor.execute('''
        INSERT INTO formasi2 (warna, baris, kolom) VALUES (?, ?, ?)
