...
# Baca file HTML
with open('E:/Voucher Selebrasi/Formasi 2/formasi2.html', 'r', encoding='utf-8') as f:
    html = f.read()
...
# Simpan ke file JSON
with open('E:/Voucher Selebrasi/Formasi 2/formasi2.json', 'w', encoding='utf-8') as f:
