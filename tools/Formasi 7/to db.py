...
# Buka file JSON
with open("E:/Voucher Selebrasi/Formasi 7/formasi.json", "r", encoding="utf-8") as f:
    data = json.load(f)
...
cursor.execute('''
    CREATE TABLE IF NOT EXISTS formasi7 (
...
for item in data:
    cursor.execute('''
        INSERT INTO formasi7 (warna, baris, kolom) VALUES (?, ?, ?)
