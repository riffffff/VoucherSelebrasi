...
# Buka file JSON
with open("E:/Voucher Selebrasi/Formasi 3/formasi.json", "r", encoding="utf-8") as f:
    data = json.load(f)
...
cursor.execute('''
    CREATE TABLE IF NOT EXISTS formasi3 (
...
for item in data:
    cursor.execute('''
        INSERT INTO formasi3 (warna, baris, kolom) VALUES (?, ?, ?)
