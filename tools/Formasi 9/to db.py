...
# Buka file JSON
with open("E:/Voucher Selebrasi/Formasi 9/formasi.json", "r", encoding="utf-8") as f:
    data = json.load(f)
...
cursor.execute('''
    CREATE TABLE IF NOT EXISTS formasi9 (
...
for item in data:
    cursor.execute('''
        INSERT INTO formasi9 (warna, baris, kolom) VALUES (?, ?, ?)
