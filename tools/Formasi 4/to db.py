...
# Buka file JSON
with open("E:/Voucher Selebrasi/Formasi 4/formasi.json", "r", encoding="utf-8") as f:
    data = json.load(f)
...
cursor.execute('''
    CREATE TABLE IF NOT EXISTS formasi4 (
...
for item in data:
    cursor.execute('''
        INSERT INTO formasi4 (warna, baris, kolom) VALUES (?, ?, ?)
