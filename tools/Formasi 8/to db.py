...
# Buka file JSON
with open("E:/Voucher Selebrasi/Formasi 8/formasi.json", "r", encoding="utf-8") as f:
    data = json.load(f)
...
cursor.execute('''
    CREATE TABLE IF NOT EXISTS formasi8 (
...
for item in data:
    cursor.execute('''
        INSERT INTO formasi8 (warna, baris, kolom) VALUES (?, ?, ?)
