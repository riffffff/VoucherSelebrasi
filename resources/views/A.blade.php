...
<body>
    ...
    @php
        $jumlah = $formasi1->where('baris', 'A')->count();
        $f1 = $formasi1->where('baris', 'A')->values();
        $f2 = $formasi2->where('baris', 'A')->values();
        $f3 = $formasi3->where('baris', 'A')->values();
        $f4 = $formasi4->where('baris', 'A')->values();
        $f5 = $formasi5->where('baris', 'A')->values();
        $f6 = $formasi6->where('baris', 'A')->values();
        $f7 = $formasi7->where('baris', 'A')->values();
        $f8 = $formasi8->where('baris', 'A')->values();
        $f9 = $formasi9->where('baris', 'A')->values();
        $f10 = $formasi10->where('baris', 'A')->values();
    @endphp
                ...
                @if ($k < $jumlah)
                    <div class="voucher">
                        <table>
                            ...
                            <thead>
                                <tr>
                                    <th colspan="3">Selebrasi Formasi Pionir Permadani 2025 | | | A-{{ $k + 1 }}</th>
                                </tr>
                                <tr>
                                    <th>Intruksi</th>
                                    <th>Warna</th>
