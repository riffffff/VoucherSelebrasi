...
<body>
    ...
    @php
        $jumlah = $formasi1->where('baris', 'B')->count();
        $f1 = $formasi1->where('baris', 'B')->values();
        $f2 = $formasi2->where('baris', 'B')->values();
        $f3 = $formasi3->where('baris', 'B')->values();
        $f4 = $formasi4->where('baris', 'B')->values();
        $f5 = $formasi5->where('baris', 'B')->values();
        $f6 = $formasi6->where('baris', 'B')->values();
        $f7 = $formasi7->where('baris', 'B')->values();
        $f8 = $formasi8->where('baris', 'B')->values();
        $f9 = $formasi9->where('baris', 'B')->values();
        $f10 = $formasi10->where('baris', 'B')->values();
    @endphp
                ...
                @if ($k < $jumlah)
                    <div class="voucher">
                        <table>
                            ...
                            <thead>
                                <tr>
                                    <th colspan="3">Selebrasi Formasi Pionir Permadani 2025 | | | B-{{ $k + 1 }}</th>
                                </tr>
                                <tr>
                                    <th>Intruksi</th>
                                    <th>Warna</th>
