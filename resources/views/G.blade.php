...
<body>
    ...
    @php
        $jumlah = $formasi1->where('baris', 'G')->count();
        $f1 = $formasi1->where('baris', 'G')->values();
        $f2 = $formasi2->where('baris', 'G')->values();
        $f3 = $formasi3->where('baris', 'G')->values();
        $f4 = $formasi4->where('baris', 'G')->values();
        $f5 = $formasi5->where('baris', 'G')->values();
        $f6 = $formasi6->where('baris', 'G')->values();
        $f7 = $formasi7->where('baris', 'G')->values();
        $f8 = $formasi8->where('baris', 'G')->values();
        $f9 = $formasi9->where('baris', 'G')->values();
        $f10 = $formasi10->where('baris', 'G')->values();
    @endphp
                ...
                @if ($k < $jumlah)
                    <div class="voucher">
                        <table>
                            ...
                            <thead>
                                <tr>
                                    <th colspan="3">Selebrasi Formasi Pionir Permadani 2025 | | | G-{{ $k + 1 }}</th>
                                </tr>
                                <tr>
                                    <th>Intruksi</th>
                                    <th>Warna</th>
