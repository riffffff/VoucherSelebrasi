...
<body>
    ...
    @php
        $jumlah = $formasi1->where('baris', 'K')->count();
        $f1 = $formasi1->where('baris', 'K')->values();
        $f2 = $formasi2->where('baris', 'K')->values();
        $f3 = $formasi3->where('baris', 'K')->values();
        $f4 = $formasi4->where('baris', 'K')->values();
        $f5 = $formasi5->where('baris', 'K')->values();
        $f6 = $formasi6->where('baris', 'K')->values();
        $f7 = $formasi7->where('baris', 'K')->values();
        $f8 = $formasi8->where('baris', 'K')->values();
        $f9 = $formasi9->where('baris', 'K')->values();
        $f10 = $formasi10->where('baris', 'K')->values();
    @endphp
                ...
                @if ($k < $jumlah)
                    <div class="voucher">
                        <table>
                            ...
                            <thead>
                                <tr>
                                    <th colspan="3">Selebrasi Formasi Pionir Permadani 2025 | | | K-{{ $k + 1 }}</th>
                                </tr>
                                <tr>
                                    <th>Intruksi</th>
                                    <th>Warna</th>
