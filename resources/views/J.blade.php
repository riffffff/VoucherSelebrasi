...
<body>
    ...
    @php
        $jumlah = $formasi1->where('baris', 'J')->count();
        $f1 = $formasi1->where('baris', 'J')->values();
        $f2 = $formasi2->where('baris', 'J')->values();
        $f3 = $formasi3->where('baris', 'J')->values();
        $f4 = $formasi4->where('baris', 'J')->values();
        $f5 = $formasi5->where('baris', 'J')->values();
        $f6 = $formasi6->where('baris', 'J')->values();
        $f7 = $formasi7->where('baris', 'J')->values();
        $f8 = $formasi8->where('baris', 'J')->values();
        $f9 = $formasi9->where('baris', 'J')->values();
        $f10 = $formasi10->where('baris', 'J')->values();
                ...
                @if ($k < $jumlah)
                    <div class="voucher">
                        <table>
                            ...
                            <thead>
                                <tr>
                                    <th colspan="3">Selebrasi Formasi Pionir Permadani 2025 | | | J-{{ $k + 1 }}
                                    </th>
                                </tr>
                                <tr>
                                    <th>Intruksi</th>
