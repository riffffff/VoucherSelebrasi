...
<body>
    ...
    @php
        $jumlah = $formasi1->where('baris', 'I')->count();
        $f1 = $formasi1->where('baris', 'I')->values();
        $f2 = $formasi2->where('baris', 'I')->values();
        $f3 = $formasi3->where('baris', 'I')->values();
        $f4 = $formasi4->where('baris', 'I')->values();
        $f5 = $formasi5->where('baris', 'I')->values();
        $f6 = $formasi6->where('baris', 'I')->values();
        $f7 = $formasi7->where('baris', 'I')->values();
        $f8 = $formasi8->where('baris', 'I')->values();
        $f9 = $formasi9->where('baris', 'I')->values();
        $f10 = $formasi10->where('baris', 'I')->values();
    @endphp
                ...
                @if ($k < $jumlah)
                    <div class="voucher">
                        <table>
                            ...
                            <thead>
                                <tr>
                                    <th colspan="3">Selebrasi Formasi Pionir Permadani 2025 | | | I-{{ $k + 1 }}</th>
                                </tr>
                                <tr>
                                    <th>Intruksi</th>
                                    <th>Warna</th>
