...
<body>
    ...
    @php
        $jumlah = $formasi1->where('baris', 'F')->count();
        $f1 = $formasi1->where('baris', 'F')->values();
        $f2 = $formasi2->where('baris', 'F')->values();
        $f3 = $formasi3->where('baris', 'F')->values();
        $f4 = $formasi4->where('baris', 'F')->values();
        $f5 = $formasi5->where('baris', 'F')->values();
        $f6 = $formasi6->where('baris', 'F')->values();
        $f7 = $formasi7->where('baris', 'F')->values();
        $f8 = $formasi8->where('baris', 'F')->values();
        $f9 = $formasi9->where('baris', 'F')->values();
        $f10 = $formasi10->where('baris', 'F')->values();
    @endphp
                ...
                @if ($k < $jumlah)
                    <div class="voucher">
                        <table>
                            ...
                            <thead>
                                <tr>
                                    <th colspan="3">Selebrasi Formasi Pionir Permadani 2025 | | | F-{{ $k + 1 }}</th>
                                </tr>
                                <tr>
                                    <th>Intruksi</th>
                                    <th>Warna</th>
