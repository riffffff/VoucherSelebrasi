...
<body>
    ...
    @php
        $jumlah = $formasi1->where('baris', 'E')->count();
        $f1 = $formasi1->where('baris', 'E')->values();
        $f2 = $formasi2->where('baris', 'E')->values();
        $f3 = $formasi3->where('baris', 'E')->values();
        $f4 = $formasi4->where('baris', 'E')->values();
        $f5 = $formasi5->where('baris', 'E')->values();
        $f6 = $formasi6->where('baris', 'E')->values();
        $f7 = $formasi7->where('baris', 'E')->values();
        $f8 = $formasi8->where('baris', 'E')->values();
        $f9 = $formasi9->where('baris', 'E')->values();
        $f10 = $formasi10->where('baris', 'E')->values();
    @endphp
                ...
                @if ($k < $jumlah)
                    <div class="voucher">
                        <table>
                            ...
                            <thead>
                                <tr>
                                    <th colspan="3">Selebrasi Formasi Pionir Permadani 2025 | | | E-{{ $k + 1 }}</th>
                                </tr>
                                <tr>
                                    <th>Intruksi</th>
                                    <th>Warna</th>
