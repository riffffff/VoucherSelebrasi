...
<body>
    ...
    @php
        $jumlah = $formasi1->where('baris', 'C')->count();
        $f1 = $formasi1->where('baris', 'C')->values();
        $f2 = $formasi2->where('baris', 'C')->values();
        $f3 = $formasi3->where('baris', 'C')->values();
        $f4 = $formasi4->where('baris', 'C')->values();
        $f5 = $formasi5->where('baris', 'C')->values();
        $f6 = $formasi6->where('baris', 'C')->values();
        $f7 = $formasi7->where('baris', 'C')->values();
        $f8 = $formasi8->where('baris', 'C')->values();
        $f9 = $formasi9->where('baris', '9')->values();
        $f10 = $formasi10->where('baris', 'C')->values();
    @endphp
                ...
                @if ($k < $jumlah)
                    <div class="voucher">
                        <table>
                            ...
                            <thead>
                                <tr>
                                    <th colspan="3">Selebrasi Formasi Pionir Permadani 2025 | | | C-{{ $k + 1 }}</th>
                                </tr>
                                <tr>
                                    <th>Intruksi</th>
                                    <th>Warna</th>
